...
theorem feasible : ∃ (_v0 : ℝ), ∃ (_v1 : ℝ), ∃ (_v2 : ℝ), ∃ (_v3 : ℝ), ((_v0 > (0 : ℝ)) ∧ (_v1 > (0 : ℝ)) ∧ (_v2 ≥ (0 : ℝ)) ∧ (_v1 ≤ _v0) ∧ (((_v1 - _v0) * _v2) = (0 : ℝ)) ∧ (_v3 ≥ (0 : ℝ))) := by
  refine ⟨(2 : ℝ), (1 : ℝ), (0 : ℝ), (1 : ℝ), ?_⟩
  norm_num

theorem satisfying : ∃ (_v0 : ℝ), ∃ (_v1 : ℝ), ∃ (_v2 : ℝ), ∃ (_v3 : ℝ), (((_v0 > (0 : ℝ)) ∧ (_v1 > (0 : ℝ)) ∧ (_v2 ≥ (0 : ℝ)) ∧ (_v1 ≤ _v0) ∧ (((_v1 - _v0) * _v2) = (0 : ℝ)) ∧ (_v3 ≥ (0 : ℝ))) ∧ (((_v1 - _v0) * (_v2 - _v3)) ≥ (0 : ℝ))) := by
  refine ⟨(2 : ℝ), (1 : ℝ), (0 : ℝ), (1 : ℝ), ?_⟩
  norm_num
