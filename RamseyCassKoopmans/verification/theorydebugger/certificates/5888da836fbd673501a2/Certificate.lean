...
theorem satisfying : ∃ (_v0 : ℝ), ∃ (_v1 : ℝ), ∃ (_v2 : ℝ), ∃ (_v3 : ℝ), ∃ (_v4 : ℝ), ∃ (_v5 : ℝ), ∃ (_v6 : ℝ), ∃ (_v7 : ℝ), (True ∧ (((_v7 * _v0) + ((_v6 * _v2) - (((_v7 * _v5) * _v4) * _v3))) = (((_v7 * (_v0 - (_v5 * (_v1 - _v2)))) + ((_v7 * _v5) * (_v1 - (_v4 * _v3)))) + ((_v6 - (_v7 * _v5)) * _v2)))) := by
  refine ⟨(1 : ℝ), (2 : ℝ), (0 : ℝ), (1 : ℝ), (2 : ℝ), (1 : ℝ), (1 : ℝ), (1 : ℝ), ?_⟩
  norm_num
