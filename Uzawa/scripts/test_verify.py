...
"""
    ...
    def test_current_library_inventory_and_all_theorem_counts(self):
        ...
        self.assertGreater(len(declarations), 66)
        self.assertIn("#print axioms UzawaModern.Uzawa.BalancedGrowthData.mk", fresh)
        self.assertIn("#print axioms UzawaModern.UzawaSeparation.Technology.ratio_surjective", fresh)
        self.assertNotIn("import UzawaModern", fresh)
